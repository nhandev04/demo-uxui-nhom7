        ...
        <Layout>
            <div className="bg-gradient-to-br from-[#fdf6f5] to-white py-12">
                <div className="max-w-7xl mx-auto px-6">
                    <h1 className="font-['Playfair_Display'] text-4xl text-[#6b1f15] mb-6">Thanh toán</h1>
                    {/* Steps */}
                                ...
                                <div className="flex items-center gap-3 flex-1">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center ${
                                            step >= s.num ? "bg-[#e0997d] text-white" : "bg-[#f5f5f5] text-[#9e9e9e]"
                                        }`}
                                    >
                                        <s.icon className="w-5 h-5" />
                                    </div>
                                    <span className={`text-sm ${step >= s.num ? "text-[#424242]" : "text-[#9e9e9e]"}`}>
                                        {s.label}
                                    </span>
                                </div>
                                {idx < 2 && (
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-[#f5f5f5] p-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm text-[#757575] mb-2">
                                        Quận/Huyện <span className="text-[#ef4444]">*</span>
                                    </label>
                                    <select
                                        required
                            ...
                            <div className="space-y-4 mb-6">
                                {cartItems.map((item, idx) => (
                                    <div key={idx} className="flex gap-3">
                                        ...
                                        <span className="text-sm text-[#e0997d]">
