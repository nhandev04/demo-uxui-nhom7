                        ...
                        >
                            ...
                            <div className="relative h-full max-w-7xl mx-auto px-6 flex items-center">
                                <div className="max-w-2xl text-white">
                                    <h1 className="font-['Playfair_Display'] text-6xl mb-4">{banner.title}</h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {[
                            ...
                            <div
                                key={idx}
                                className="flex gap-4 p-4 sm:p-6 rounded-xl hover:bg-[#fdf6f5] transition-colors duration-200"
                            >
            ...
            <section className="py-16 sm:py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 sm:mb-12 gap-4">
                        <div>
                            <span className="text-sm sm:text-base text-[#e0997d] tracking-wider uppercase">
                                Nổi bật
                            </span>
                            <h2 className="font-['Montserrat'] text-2xl sm:text-3xl lg:text-4xl text-[#6b1f15] mt-2">
                                Sản phẩm nổi bật
            ...
            <div className="relative h-64 overflow-hidden bg-[#fafafa]">
                ...
                {product.isNew && (
                    <div className="absolute top-4 right-4">
                        <span className="px-3 py-1 bg-[#10b981] text-white text-sm rounded-full">Mới</span>
                    </div>
                )}
