                ...
                <div className="grid md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-3">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-xl text-[#757575] leading-relaxed mb-8">{post.excerpt}</p>

                            <p className="text-[#757575] leading-relaxed mb-6">
                                Chăm sóc hoa đúng cách không chỉ giúp hoa tươi lâu hơn mà còn mang lại không gian sống
                                đẹp và thư thái. Mỗi loại hoa có những yêu cầu chăm sóc khác nhau, từ việc tưới nước,
                                thay nước bình hoa đến điều kiện ánh sáng và nhiệt độ phù hợp.
                            </p>
                            ...
                            <p className="text-[#757575] leading-relaxed mb-6">
                                Khi chăm sóc hoa đúng cách, bạn sẽ thấy sự khác biệt rõ rệt trong độ tươi và vẻ đẹp của
                                hoa. Hoa được chăm sóc tốt có thể giữ được hương thơm và màu sắc tươi tắn trong thời
                                gian dài hơn, mang lại niềm vui và sự thư giãn cho không gian sống của bạn.
                            </p>
                            ...
                            <img src={post.image} alt="Hướng dẫn chăm sóc hoa" className="w-full rounded-2xl mb-8" />
                            ...
                            <p className="text-[#757575] leading-relaxed mb-6">
                                Để hoa luôn tươi đẹp, bạn nên thay nước bình hoa 2-3 ngày một lần, cắt chéo phần gốc hoa
                                khoảng 2-3cm để hoa hấp thụ nước tốt hơn. Đặt hoa ở nơi thoáng mát, tránh ánh nắng trực
                                tiếp và xa các nguồn nhiệt. Ngoài ra, bạn có thể thêm một ít đường hoặc thuốc dưỡng hoa
                                vào nước để kéo dài tuổi thọ của hoa.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-12 pt-8 border-t border-[#f5f5f5]">
                            ...
                            {["Hoa tươi", "Chăm sóc", "Hướng dẫn"].map((tag) => (
                                <span key={tag} className="px-3 py-1 bg-[#fdf6f5] text-[#e0997d] text-sm rounded-full">
                                    {tag}
                                </span>
                            ))}
                        </div>
