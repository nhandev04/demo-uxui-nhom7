                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                readOnly={!showEmail}
                                className="w-full px-4 py-3 pr-12 bg-[#fdf6f5] border border-[#f0ccc3] rounded-xl focus:outline-none focus:border-[#e0997d] focus:ring-2 focus:ring-[#e0997d]/20"
                                required
                            />
                            <button
                                type="button"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                type="tel"
                                value={showPhone ? formData.phone : maskPhoneNumber(formData.phone)}
                ...
                <div className="bg-[#fdf6f5] rounded-xl p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-[#757575]">Cập nhật mật khẩu của bạn để bảo vệ tài khoản</p>
                        </div>
                    </div>
                    <button
                        type="button"
