            ...
            <div className="bg-white rounded-2xl border border-[#f5f5f5] p-8">
                            ...
                            <div key={idx} className="flex items-start gap-4">
                                <div className="relative">
                                    ...
                                    {idx < timeline.length - 1 && (
                                        <div
                                            className={`absolute left-5 top-10 w-0.5 h-12 ${step.completed ? "bg-[#10b981]" : "bg-[#f5f5f5]"}`}
                                        />
                                    )}
                                </div>
                ...
                <div className="mb-8 pb-8 border-b border-[#f5f5f5]">
                    ...
                    <div className="p-4 bg-[#fdf6f5] rounded-xl text-[#757575]">
                        ...
                        <p className="mb-1">{maskPhoneNumber("0123456789")}</p>
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between text-[#757575]">
                            <span>Tạm tính</span>
                            <span>{formatPrice(order.total - 50000)}₫</span>
                        </div>
                        <div className="flex justify-between text-[#757575]">
                        ...
                        <div className="flex justify-between pt-4 border-t border-[#f5f5f5]">
                            ...
                            <span className="text-2xl text-[#e0997d]">{formatPrice(order.total)}₫</span>
                        </div>
                    </div>
                </div>
            </div>
