...
import { formatPrice, maskPhoneNumber } from "../utils/formatters";
            ...
            <div className="min-h-[600px] bg-gradient-to-br from-[#fdf6f5] to-white py-24">
                <div className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="font-['Playfair_Display'] text-4xl text-[#6b1f15] mb-4">Đặt hàng thành công!</h1>
                        <p className="text-[#757575] text-lg mb-2">Cảm ơn bạn đã đặt hàng tại Flora Garden</p>
                                ...
                                <div key={idx} className="flex items-center gap-4">
                                    <div
                                        className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                                            step.active ? "bg-[#e0997d] text-white" : "bg-[#f5f5f5] text-[#9e9e9e]"
                                        }`}
                                    >
                                        <step.icon className="w-6 h-6" />
                                    </div>
                                    <span className={step.active ? "text-[#424242]" : "text-[#9e9e9e]"}>
                                        {step.label}
                                    </span>
                                </div>
                            ))}
                    ...
                    <div className="bg-white rounded-2xl border border-[#f5f5f5] p-8 mb-8">
                        ...
                        <div className="space-y-4 mb-6 pb-6 border-b border-[#f5f5f5]">
                            {orderDetails.items.map((item, idx) => (
                                <div key={idx} className="flex justify-between">
                                    ...
                                    <span className="text-[#424242]">{formatPrice(item.price * item.quantity)}₫</span>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="flex justify-between pt-4 border-t border-[#f5f5f5]">
                            ...
                            <span className="text-2xl text-[#e0997d]">{formatPrice(orderDetails.total)}₫</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-[#f5f5f5] p-8 mb-8">
                        ...
                        <div className="text-[#757575]">
                            ...
                            <p className="mb-1">{maskPhoneNumber(orderDetails.shipping.phone)}</p>
