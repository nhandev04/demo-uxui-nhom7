        ...
        return (
            <Layout>
                <div className="max-w-4xl mx-auto px-6 py-24 text-center">
                    ...
                    <h2 className="font-['Playfair_Display'] text-3xl text-[#6b1f15] mb-4">Giỏ hàng trống</h2>
                    <p className="text-[#757575] mb-8">Hãy thêm sản phẩm vào giỏ hàng để tiếp tục mua sắm</p>
                    <Link
                        to="/products"
        ...
        <Layout>
            ...
            <div className="bg-gradient-to-br from-[#fdf6f5] to-white py-12">
                <div className="max-w-7xl mx-auto px-6">
                    <h1 className="font-['Playfair_Display'] text-4xl text-[#6b1f15] mb-2">Giỏ hàng</h1>
                                ...
                                <div className="flex gap-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center justify-between mt-4">
                                            <span className="text-xl text-[#e0997d]">{formatPrice(item.price)}₫</span>
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="pt-4 border-t border-[#f5f5f5]">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-2xl text-[#e0997d]">{formatPrice(total)}₫</span>
                                    </div>
                                </div>
                            </div>
