            ...
            <div className="bg-[#fdf6f5] py-4">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center gap-2 text-sm text-[#757575]">
                        <Link to="/" className="hover:text-[#e0997d]">
                            Trang chủ
                        </Link>
                        <span>/</span>
                        <Link to="/products" className="hover:text-[#e0997d]">
                            Sản phẩm
                        </Link>
                        <span>/</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
                        ...
                        <div className="sticky top-24">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                {[1, 2, 3, 4].map((i) => (
                                    <div
                                        key={i}
                                        className="aspect-square rounded-xl overflow-hidden border-2 border-transparent hover:border-[#e0997d] cursor-pointer transition-colors"
                                    >
                    ...
                    <div>
                        ...
                        <h1 className="font-['Playfair_Display'] text-4xl text-[#6b1f15] mb-4">{product.name}</h1>
                        ...
                        <div className="flex items-baseline gap-4 mb-6">
                            <span className="text-4xl text-[#e0997d]">{formatPrice(product.price)}₫</span>
                            {product.originalPrice && (
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[#757575]">{product.stock} sản phẩm có sẵn</span>
                            </div>
                        </div>
                ...
                <div className="mb-16">
                    <div className="bg-white rounded-2xl border border-[#f5f5f5] p-8">
                        <h2 className="font-['Playfair_Display'] text-3xl text-[#6b1f15] mb-8">Đánh giá sản phẩm</h2>
                                ...
                                <div key={review.id} className="pb-6 border-b border-[#f5f5f5] last:border-0">
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-[#757575] leading-relaxed mb-3">{review.content}</p>
                ...
                {relatedProducts.length > 0 && (
                    <div className="mb-16">
                        <h2 className="font-['Playfair_Display'] text-3xl text-[#6b1f15] mb-8">Sản phẩm liên quan</h2>
                            ...
                            {relatedProducts.map((product) => (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <span className="text-lg text-[#e0997d]">{formatPrice(product.price)}₫</span>
                                    </div>
                                </Link>
                            ))}
                        </div>
                ...
                {/* Related Blog Posts */}
                <div className="mb-16">
                    <h2 className="font-['Playfair_Display'] text-3xl text-[#6b1f15] mb-8">Bài viết liên quan</h2>
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-sm text-[#757575] line-clamp-2">
                                    Bí quyết giúp hoa hồng của bạn tươi đẹp và giữ được hương thơm lâu hơn với những mẹo
                                    đơn giản.
                                </p>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-sm text-[#757575] line-clamp-2">
                                    Mỗi màu hoa hồng đều mang một thông điệp riêng. Tìm hiểu để chọn màu phù hợp cho
                                    từng dịp.
                                </p>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-sm text-[#757575] line-clamp-2">
                                    Hướng dẫn chi tiết về cách chọn loại hoa và kiểu cắm phù hợp với từng sự kiện quan
                                    trọng.
                                </p>
                            </div>
                        </Link>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-[#757575]">
                                Đội ngũ florist chuyên nghiệp sẽ tạo nên bó hoa hoàn hảo theo phong cách và ngân sách
                                của bạn
                            </p>
                        </div>
                        <Link
